  ...
  return (
    <>
      <Button
        variant="outline"
        className={cn(
          "relative hidden text-foreground h-10 w-auto items-center justify-start gap-2 rounded-[0.5rem] bg-background font-normal shadow-none sm:pr-12 lg:flex lg:w-96",
        )}
